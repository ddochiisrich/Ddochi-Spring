...
<div class="row my-5" id="global-content">
	<div class="col">
		<div class="row my-3 text-center">
			<div class="col">
				<h2 class="fs-3 fw-bold">회원 정보 수정하자!</h2>
			</div>
		</div>
			...
			<div class="row my-3">
				<div class="col-8 offset-2">
					...
					<div class="row">
						...
						<div class="col-4">
							<input type="button" class="btn btn-danger" id="btnPassCheck" value="비밀번호 확인">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row my-3">
				<div class="col-8 offset-2">
					<label for="address2" class="form-label">상세주소 : </label> <input
						type="text" class="form-control" name="address2" id="address2" value="${ sessionScope.member.address2 }">
				</div>
			</div>
			<div class="row my-3">
				<div class="col-8 offset-2">
					...
					<div class="row">
						<div class="col-md-4">
							<input type="text" class="form-control" name="emailId"
								id="emailId" value="${ sessionScope.member.email.split('@')[0] }">
						</div>
						@
						<div class="col-md-4">
							<input type="text" class="form-control" name="emailDomain"
								id="emailDomain" value="${ sessionScope.member.email.split('@')[1] }">
						</div>
						<div class="col-md-3">
							<select class="form-select" name="selectDomain" id="selectDomain">
								...
								<option ${ sessionScope.member.email.split('@')[1] == 'hanmail.com' ? 'selected' : ''}>한메일</option>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="mobile2"
								id="mobile2" maxlength="4" value="${ sessionScope.member.mobile.split('-')[1]}">
						</div>
						-
						<div class="col-md-4">
							<input type="text" class="form-control" name="mobile3"
								id="mobile3" maxlength="4" value="${ sessionScope.member.mobile.split('-')[2]}">
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-md-3">
							<div class="form-check">
								<input type="radio" class="form-check-input" name="emailGet"
									id="emailOk" value="true" ${ member.emailGet ? "checked" : "" }> <label
									class="form-check-label" for="emailOk">수신함</label>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-check">
								<input type="radio" class="form-check-input" name="emailGet"
									id="emailNo" value="false" ${ member.emailGet ? "" : "checked" }> <label
									class="form-check-label" for="emailNo">수신안함</label>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-3">
							<select class="form-select" name="phone1" id="phone1">
								<option ${ sessionScope.member.mobile.split('-')[0] == '02' ? 'selected' : '' }>02</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '031' ? 'selected' : '' }>031</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '032' ? 'selected' : '' }>032</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '033' ? 'selected' : '' }>033</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '041' ? 'selected' : '' }>041</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '042' ? 'selected' : '' }>042</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '043' ? 'selected' : '' }>043</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '044' ? 'selected' : '' }>044</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '051' ? 'selected' : '' }>051</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '052' ? 'selected' : '' }>052</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '053' ? 'selected' : '' }>053</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '054' ? 'selected' : '' }>054</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '055' ? 'selected' : '' }>055</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '061' ? 'selected' : '' }>061</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '062' ? 'selected' : '' }>062</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '063' ? 'selected' : '' }>063</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '064' ? 'selected' : '' }>064</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '010' ? 'selected' : '' }>010</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '011' ? 'selected' : '' }>011</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '016' ? 'selected' : '' }>016</option>
								<option ${ sessionScope.member.mobile.split('-')[0] == '017' ? 'selected' : '' }>017</option>
						...
						<div class="col-md-4">
							<input type="text" class="form-control" name="phone2" id="phone2"
								maxlength="4" value="${ sessionScope.member.phone.split('-')[1] }">
						</div>
						-
						<div class="col-md-4">
							<input type="text" class="form-control" name="phone3" id="phone3"
								maxlength="4" value="${ sessionScope.member.phone.split('-')[2] }">
						</div>
					</div>
				</div>
			</div>
