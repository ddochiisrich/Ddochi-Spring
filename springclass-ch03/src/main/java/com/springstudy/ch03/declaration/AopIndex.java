...
public class AopIndex {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext("config/AopAnnotationContext.xml");
		
		MessageBeanAspectJAnnotation bean1 = ctx.getBean("messageBean", MessageBeanAspectJAnnotation.class);
		...
		MessageBeanAnnotation bean2 = ctx.getBean("messageAnnotation", MessageBeanAnnotation.class);
